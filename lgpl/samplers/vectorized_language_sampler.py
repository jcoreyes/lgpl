...
from lgpl.utils.torch_utils import Variable, from_numpy, get_numpy
import gym

class VectorizedLanguageSampler(Sampler):
    def __init__(self, env_name, n_envs, grammar, envs=None, random_action_p=0, **kwargs):
...
class ParVectorizedLanguageSampler(VectorizedLanguageSampler):
